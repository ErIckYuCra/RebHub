...
export async function POST(request: NextRequest) {
  try {
    ...
    // Auto-index embedding (non-blocking — don't fail the request if it errors)
    embeddingService.upsert({ article_id: data.id, title: data.title, summary: data.summary }).catch(console.error)
